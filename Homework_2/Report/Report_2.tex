...
Overall, considering its simplicity and low computational cost, the HLLE solver showed good handling of the Sod problem resolution. However, simulations where high shock resolution is needed, might require more advanced and computationally expensive Riemann solvers.
