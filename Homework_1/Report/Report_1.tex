...
\textit{dissipative} term in the \acrshort{aeq}; this means that the magnitude
...
the grid or the Courant factor helps in preserving the initial magnitude of the
...
that are not lines anymore. Like before the drop in magnitude of the norm is
